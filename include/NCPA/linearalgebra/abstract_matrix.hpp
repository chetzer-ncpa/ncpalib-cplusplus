    ...
    namespace linear {
        ...
        class abstract_matrix {
            public:
                ...
                // @todo expand logic
                virtual bool is_band_diagonal() const { return false; }
                ...
                virtual std::unique_ptr<abstract_vector<ELEMENTTYPE>>
                    ...
                    if (rows() != v.size()) {
                        ...
                        oss << "Size mismatch in vector-matrix "
                               "multiplication: "
                            << v.size() << " elements in vector vs " << rows()
                            << " rows in matrix";
                        throw std::invalid_argument( oss.str() );
                    }
                ...
                virtual std::unique_ptr<abstract_matrix<ELEMENTTYPE>> multiply(
                    ...
                    for (int k = 0; k < (int)this->columns(); ++k) {
                        ...
                        int rmax = std::min( k + albw, (int)this->rows() - 1 );
                ...
                virtual abstract_matrix<ELEMENTTYPE>& set_column(
                    ...
                    return set_column( column, row_inds.size(), &row_inds[ 0 ],
                                       &vals[ 0 ] );
                }
                ...
                virtual abstract_matrix<ELEMENTTYPE>& set_column(
                    ...
                    return set_column( column, std::vector<size_t>( row_inds ),
                ...
                virtual abstract_matrix<ELEMENTTYPE>& set_diagonal(
                    ...
                    return set_diagonal( std::vector<ELEMENTTYPE>(
                                             diagonal_size( offset ), val ),
                                         offset );
                }
                ...
                virtual abstract_matrix<ELEMENTTYPE>& set_row(
                    ...
                    return set_row( row, column_inds.size(), &column_inds[ 0 ],
                                    &vals[ 0 ] );
                }
                ...
                virtual abstract_matrix<ELEMENTTYPE>& set_row(
                    ...
                    // abstract matrix" << std::endl;
                    return set_row( row, std::vector<size_t>( column_inds ),
                                    std::vector<ELEMENTTYPE>( vals ) );
                }
                ...
                virtual abstract_matrix<ELEMENTTYPE>& set_row(
                    ...
                    return set_row(
                        row, NCPA::arrays::index_vector<size_t>( vals.size() ),
                        vals );
                }
                ...
                virtual abstract_matrix<ELEMENTTYPE>& zero( size_t row,
                                                            size_t col ) {
                    return set( row, col, NCPA::math::zero<ELEMENTTYPE>() );
                }
                ...
                virtual abstract_matrix<ELEMENTTYPE>& operator-=(
                    const abstract_matrix<ELEMENTTYPE>& other ) {
                    add( other, -NCPA::constants::one<ELEMENTTYPE>() );
                    return *this;
                }
                ...
                virtual abstract_matrix<ELEMENTTYPE>& operator/=(
                    const ELEMENTTYPE& other ) {
                    scale( NCPA::constants::one<ELEMENTTYPE>() / other );
                    return *this;
                }
