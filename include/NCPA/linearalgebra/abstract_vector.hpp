        ...
        class abstract_vector
            ...
            public:
                ...
                virtual ELEMENTTYPE dot(
                    const abstract_vector<ELEMENTTYPE>& b ) const        = 0;
                ...
                virtual abstract_vector<ELEMENTTYPE>& scale(
                    const abstract_vector<ELEMENTTYPE>& b ) = 0;
                virtual abstract_vector<ELEMENTTYPE>& set( size_t n,
                                                           ELEMENTTYPE val )
                    = 0;
                virtual abstract_vector<ELEMENTTYPE>& set(
                    size_t n, const ELEMENTTYPE *val ) = 0;
                virtual abstract_vector<ELEMENTTYPE>& set(
                    const std::vector<ELEMENTTYPE>& v ) = 0;
                ...
                virtual abstract_vector<ELEMENTTYPE>& zero(
                    const std::vector<size_t>& n ) = 0;
                virtual abstract_vector<ELEMENTTYPE>& zero(
                    std::initializer_list<size_t> n ) = 0;

                // implementations, not abstract
                template<typename OTHERTYPE>
                bool equals( const abstract_vector<OTHERTYPE>& other ) const {
                    return false;
                }
                ...
                virtual std::vector<size_t> nonzero_index_union(
                    ...
                    std::set_union( nz_a.cbegin(), nz_a.cend(), nz_b.cbegin(),
                                    nz_b.cend(), std::back_inserter( keep ) );
                    return keep;
                }
...
// template<typename T>
// static void swap( NCPA::linear::abstract_vector<T>& a,
//                   NCPA::linear::abstract_vector<T>& b ) noexcept {}
