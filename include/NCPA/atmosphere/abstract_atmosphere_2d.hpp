        ...
        class abstract_atmosphere_2d : public Cloneable<abstract_atmosphere_2d> {
            public:
                ...
                virtual abstract_atmosphere_2d& set(
                    ...
                    std::vector<abstract_atmosphere_1d *> components ) = 0;
                ...
                virtual abstract_atmosphere_2d& append(
                    scalar_u_t range, abstract_atmosphere_1d& atmos1d ) = 0;
                ...
                virtual abstract_atmosphere_2d& add_property(
                    ...
                    const AtmosphericProperty2D& property ) = 0;
                 ...
                 */
                virtual abstract_atmosphere_2d& add_property(
                    const std::string& key, const vector_u_t& property ) = 0;
                 ...
                 * @return double
                 */
                virtual double get( const std::string& key, double r ) = 0;
