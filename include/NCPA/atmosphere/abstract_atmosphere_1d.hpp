...
namespace NCPA {
    namespace atmos {
         ...
         * @brief
         */
        class abstract_atmosphere_1d : public Cloneable<abstract_atmosphere_1d> {
            public:
                /**
                 * @brief
                 */
                ...
                virtual abstract_atmosphere_1d& add_property(
                    ...
                    const AtmosphericProperty1D& property ) = 0;
                /**
                 * @brief
                 * @param key
                 * @param property
                ...
                virtual std::vector<AtmosphericProperty1D> properties() const {
                    ...
                    for (auto keyit = keys.cbegin(); keyit != keys.cend();
                         ++keyit) {
                ...
                virtual std::vector<scalar_u_t> scalars() const {
                    ...
                    for (auto keyit = keys.cbegin(); keyit != keys.cend();
                         ++keyit) {
                        sc.emplace_back( this->get( *keyit ),
                                         this->get_units( *keyit ) );
                    }
                    return sc;
                }
        };
