        ...
        class ConfigurationMap
            ...
            public:
                ...
                friend void swap( ConfigurationMap<KEYTYPE>& a,
                    ...
                    using std::swap;
                    swap( static_cast<std::unordered_map<
                              KEYTYPE, NCPA::config::param_ptr_t>&>( a ),
                          static_cast<std::unordered_map<
                              KEYTYPE, NCPA::config::param_ptr_t>&>( b ) );
                }
...
//     using std::swap;
//     swap( static_cast<std::unordered_map<KEYTYPE,
//     NCPA::config::param_ptr_t>&>(
//               a ),
//           static_cast<std::unordered_map<KEYTYPE,
//           NCPA::config::param_ptr_t>&>(
//               b ) );
// }
