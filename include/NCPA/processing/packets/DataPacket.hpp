...
namespace NCPA {
    namespace processing {
        ...
        template<typename T>
        void swap( DataPacket<T>& a, DataPacket<T>& b ) noexcept;
        ...
        class DataPacket : public InputPacket,
            ...
            public:
                ...
                DataPacket( const DataPacket<T>& other ) :
                    InputPacket( other ) {
                ...
                DataPacket( DataPacket<T>&& input ) noexcept :
                    DataPacket<T>() {
                    ::swap( *this, input );
                }
                ...
                friend void swap<>( DataPacket<T>& a,
                                    DataPacket<T>& b ) noexcept;
